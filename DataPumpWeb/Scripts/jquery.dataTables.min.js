...
if (a.nTFoot !== null) { L.style.width = q(a.nTable.offsetWidth + a.oScroll.iBarWidth); T.style.width = q(a.nTable.offsetWidth) } if (a.bSorted || a.bFiltered) d.scrollTop = 0
    ...
    var b = a.oLanguage.sSearch; b = b.indexOf("_INPUT_") !== -1 ? b.replace("_INPUT_", '<input id="searchInput" type="text" />') : b === "" ? '<input id="searchInput" type="text" />' : b + ' <input id="searchInput" type="text" />'; var c = p.createElement("div");
